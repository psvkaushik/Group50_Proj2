...
def get_github_branches(owner, repo):
    try:
        ...
        headers = {
            'Authorization': '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',
        }
...
if __name__ == "__main__":
    owner = 'VaishnaviNaik96'  # Replace with the GitHub username or organization name.
    repo = 'test_510'  # Replace with the name of the GitHub repository.
